...
import supplies from '../../assets/img/supplies.jpg';
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    <article className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-4">
                        <div className="flex aspect-4/3 items-center justify-center rounded-[1.25rem] bg-zinc-200">
                            <img src={fan} alt="Fan" className="h-full w-full object-cover" />
                        </div>
                    ...
                    <article className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-4">
                        <div className="flex aspect-4/3 items-center justify-center rounded-[1.25rem] bg-zinc-200">
                            <img src={supplies} alt="Study Supplies" className="h-full w-full object-cover" />
                        </div>
                    ...
                    <article className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-4">
                        <div className="flex aspect-4/3 items-center justify-center rounded-[1.25rem] bg-zinc-200">
                            <img src={tshirt} alt="T-Shirt" className="h-full w-full object-cover" />
                        </div>
