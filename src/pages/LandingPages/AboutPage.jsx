...
import tumb from '../../assets/img/tumb.webp';
const AboutPage = () => {
  return (
          ...
          <div className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-5">
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              ...
              <div className="flex aspect-square items-center justify-center rounded-[1.25rem] bg-zinc-200">
                <img src={lanyard} alt="Lanyard" className="h-full w-full object-cover" />
              </div>
              <div className="flex aspect-square items-center justify-center rounded-[1.25rem] bg-zinc-200">
                <img src={totebag} alt="Totebag" className="h-full w-full object-cover" />
              </div>
              <div className="flex aspect-square items-center justify-center rounded-[1.25rem] bg-zinc-200">
                <img src={tumb} alt="Tumbler" className="h-full w-full object-cover" />
              </div>
            </div>
